...
describe Openhbx::Cv2::Contact, "given a sample xml" do
...
<contact xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns='http://openhbx.org/api/terms/1.0'>
  <id>
    <id>#{contact_id}</id>
  </id>
  <person_name>
...
XMLDOC
  ...
  subject { Openhbx::Cv2::Contact.parse(input_xml, single: true) }
